...
exports.xCsrfTokenHeaderKey = exports.shouldHandleCsrfToken = exports.getAxiosConfigWithDefaultsWithoutMethod = exports.getAxiosConfigWithDefaults = exports.executeHttpRequest = exports.buildAxiosRequestConfig = exports.execute = exports.addDestinationToRequestConfig = exports.buildHttpRequest = void 0;
...
function execute(executeFn) {
    return function (destination, requestConfig, httpRequestOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = request;
                        return [4 /*yield*/, addCsrfTokenToHeader(destination, request, httpRequestOptions)];
                    case 2:
                        _a.headers = _b.sent();
...
exports.xCsrfTokenHeaderKey = 'x-csrf-token';
function getCsrfHeaders(destination, headers, url) {
    return __awaiter(this, void 0, void 0, function () {
        var csrfHeaders;
        return __generator(this, function (_a) {
            csrfHeaders = util_1.pickIgnoreCase(headers, exports.xCsrfTokenHeaderKey);
            return [2 /*return*/, Object.keys(csrfHeaders).length
                    ? csrfHeaders
                    : scp_cf_1.buildCsrfHeaders(destination, {
                        headers: headers,
                        url: url
                    })];
        });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getCsrfHeaders(destination, request.headers, request.url)];
                case 1:
                    _a = _b.sent();
                    return [3 /*break*/, 3];
                case 2:
