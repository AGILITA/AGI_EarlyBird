    ...
    OpenApiRequestBuilder.prototype.executeRaw = function (destination) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                fetchCsrfToken = ['post', 'put', 'patch', 'delete'].includes(this.method.toLowerCase());
                return [2 /*return*/, http_client_1.executeHttpRequest(destination, {
                        method: this.method,
                        url: this.getPath(),
                        headers: this.customHeaders,
                        params: (_a = this.parameters) === null || _a === void 0 ? void 0 : _a.queryParameters,
                        data: (_b = this.parameters) === null || _b === void 0 ? void 0 : _b.body
                    }, 
    ...
    OpenApiRequestBuilder.prototype.getPath = function () {
        ...
        return pathParts
            ...
            if (OpenApiRequestBuilder.isPlaceholder(part)) {
                ...
                if (!paramValue) {
                    throw new Error("Cannot execute request, no path parameter provided for '" + paramName + "'.");
                }
